...
public final class SupabaseUserBrowseService: UserBrowseService {
    ...
    public func seedFakeUsers() {
        ...
        let chairmanMeowPhoto = Self.seedPhoto(named: "SeedSocial1")
        let beansPhoto = Self.seedPhoto(named: "SeedSocial2")
        let professorPhoto = Self.seedPhoto(named: "SeedSocial3")
        let noodlePhoto = Self.seedPhoto(named: "SeedSocial4")
        let biscuitPhoto = Self.seedPhoto(named: "SeedSocial5")
        let ghostPhoto = Self.seedPhoto(named: "SeedSocial6")
        let gremlinPhoto = Self.seedPhoto(named: "SeedSocial7")
