...
final class CKUserBrowseServiceTests: XCTestCase {
    ...
    func testBatchFetchDisplayNamesSkipsCachedUsers() async {
        ...
        // Now batch-fetch user-1 and user-2
        ...
        // user-1 should come from cache, only user-2 should be fetched
    ...
    func testBatchFetchDisplayNamesHandlesNotFoundUsers() async {
        ...
        // user-2 has no profile, fetchResult is nil by default
    ...
    func testBatchFetchedNamesAvailableViaFetchDisplayName() async {
        ...
        // Subsequent fetchDisplayName should use cache
        let name = await sut.fetchDisplayName(userID: "user-1")
